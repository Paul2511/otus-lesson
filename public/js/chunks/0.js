...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setTitle: function setTitle() {
      ...
      var item = this.navMenuItems.find(function (n) {
        return n.url === _this.currentPath;
      });
...
var staticRenderFns = [
  function(_h, _vm) {
    var _c = _vm._c
    return _c("p", [
      _c("span", [_vm._v("Разработано в качестве проектной работы для OTUS")])
    ])
  }
]
render._withStripped = true
    ...
    _c(
      ...
      [
        _c(
          ...
          [
            _vm.windowWidth >= 992
              ? _c("div", [_c("h3", [_vm._v(_vm._s(_vm.$t(_vm.headerTitle)))])])
              : _vm._e(),
            _vm._v(" "),
            _c("feather-icon", {
        ...
        [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("small", [_vm._v(_vm._s(_vm.activeUserInfo.displaySpec))])
            ]
          ),
          _vm._v(" "),
          _c(
...
module.exports = "/images/logo.png?186c2d999925416fa5e0ec2d441a38fb";
