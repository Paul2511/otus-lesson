...
namespace Tests\Feature\Http\Controllers\Sources\OnlineStatistic;
...
class SourcesOnlineStatisticControllerViewTest extends TestCase
{
    /**
     * @group source
     */
    ...
    {
        $response = $this->get(
            route(SourcesRoutes::SOURCES_STATISTIC_ONLINE)
        );
    ...
    {
        $user=UsersGenerator::generatePlain();
        $user= UsersGenerator::addResourceForUser($user, Resources::STATISTIC_ONLINE);
