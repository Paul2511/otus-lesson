    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <p class="mb-4"><a href="{{ route('about') }}"
                                   class="btn btn-primary rounded text-white px-4">Подробнее</a></p>
            ...
            <div class="col-md-2">
                ...
                <p class="mb-2">&#9742; <a class="a-link"
                                           href="tel:{{ __('+7-(999)-876-54-32') }}">+7-(999)-876-54-32</a></p>
                <p class="mb-0 font-weight-bold">Email-адрес</p>
                <p class="mb-0">&#9993; <a class="a-link" href="mailto:m-a-grigoreva@yandex.ru">support@sportfit.ru</a>
                </p>
            </div>
        </div>
    </div>
    <div class="row p-4 text-center">
        <div class="col-md-12">
            <small>
                ...
                Сайт разработан <i class="icon-heart text-danger" aria-hidden="true"></i> <a
                    href="mailto:m-a-grigoreva@yandex.ru">Григорьевой Марией</a> на Laravel5
            </small>
        </div>
    </div>
</footer>
