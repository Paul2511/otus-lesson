...
@section('scripts')
    ...
    <script src="{{asset('assets/js/users/user-edit.js')}}"></script>
    <script src="{{asset('plugins/notification/snackbar/snackbar.min.js')}}"></script>
    <script>
        let user_resources = JSON.parse('{{$resources}}');
        let user_projects = JSON.parse('{{$projects}}');
        {{--let user_id = "{{$user->id}}";--}}
        let route_update = "{{route(App\Services\Routes\Providers\Admin\AdminRoutes::ADMIN_USERS_UPDATE, ['user' => $user->id]) }}";
                ...
                <div class="account-settings-container layout-top-spacing">
                                                            ...
                                                            <div class="form">
                                                                <div class="row">
                                                                    <div class="col-sm-5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" id="fullName" placeholder="" value="{{$user->full_name}}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-5">
                                                                        <div class="form-group">
                                                                            <label for="email">Email</label>
                                                                            <input type="text" class="form-control mb-4" id="email" placeholder="" value="{{$user->email}}" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-2">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control mb-4" id="phone" placeholder="" value="{{$user->phone}}">
                                                                    </div>
                                                                </div>
                                                                </div>
                                                            </div>
                    ...
                    <div class="account-settings-footer">
                        ...
                        <div class="as-footer-container">
                            ...
                            <div> </div>
                            <button id="save-changes" class="btn btn-primary" >@lang('users.SaveChanges')</button>
                        </div>
