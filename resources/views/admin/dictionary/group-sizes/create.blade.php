            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" action="{{ route('group-sizes.store') }}">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="max_count" class="form-control @error('max_count')is-invalid @enderror" id="max_count" placeholder="0" min="0" step="0">
                                </div>
