...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Code addiction dashboard</a>
                ...
                <ul class="nav flex-column mb-2">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard.role.index') }}">
                            <span data-feather="file-text"></span>
                            {{ trans('messages.role_list') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard.role.create') }}">
                            <span data-feather="file-text"></span>
                            {{ trans('messages.role_create') }}
                        </a>
                    </li>
                </ul>
